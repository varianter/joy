...
const AnimatedButton = (props: AnimatedButtonProps) => {
  const { text } = props;
  return (
    <button className="group relative inline-flex items-center justify-start overflow-hidden rounded bg-variant-blue px-6 py-3 font-medium transition-all hover:bg-variant-blue">
